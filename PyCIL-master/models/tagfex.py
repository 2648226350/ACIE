    ...
    def _update_representation(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs1, inputs2, targets) in enumerate(train_loader):
                ...
                infonce_loss = infoNCE_loss(embedding, self.args['infonce_temp'])
                loss_clf = self.loss(logits, targets)
                ...
                loss_aux = self.loss(aux_logits, aux_targets)
                ...
                trans_cls_loss = self.loss(trans_logits[cur_task_mask], targets[cur_task_mask] - self._known_classes)
