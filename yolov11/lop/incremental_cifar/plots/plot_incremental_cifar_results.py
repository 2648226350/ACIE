...
def create_plots(plot_arguments: dict):
    ...
    plt.savefig(os.path.join(file_path, metric + ".png"))


def main(algo):

    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--results_dir", action="store", type=str, default="../results/",
                        help="Path to directory containing the results of all the named experiments.")
    parser.add_argument("--algorithms", action="store", type=str, default=algo,
...
if __name__ == "__main__":
    ...
    exp1 = 'shrink_and_perturb,ACIE,continual_backpropagation'
    exp2 = 'neuron_lifecycle_manager'
    exp3 = 'retrained_network'
    main(exp1)
